...
class ResumeController {
    ...
    @GetMapping("/init")
    fun init(): Resume? {
        val yangchongResume = getYangChong()
        val yangchaoResume = getYangChao()
        yangchaoResume.account = accountService.save(yangchaoResume.account)
        yangchongResume.account = accountService.save(yangchongResume.account)
        resumeService.save(yangchongResume)
        return resumeService.save(yangchaoResume)
    }
    ...
    private fun getYangChong(): Resume {
        val synopsis = "· 勤奋好学\n" +
                "· 喜欢美女\n" +
                "· 热爱打炮"
        val account = Account("18482101719", "123456", "杨冲", 23, 0, "786372615@qq.com",
                UUID.randomUUID().toString(), UUID.randomUUID().toString())

        val baseInfo = BaseInfo("杨冲", "18482101719", 23, 0, "786372615@qq.com", "http://www.lgstatic.com/i/image2/M01/2F/09/CgoB5lzZKZOAZFlbAABCFbmSTGs258.jpg")
        ...
        return Resume("yangchong", account, baseInfo, synopsis, 2, Company("垃圾公司"), "Android", language, technique, professionalExperiences, edu)
    }

    private fun getYangChao(): Resume {
        val baseInfo = BaseInfo("杨超", "13550310197", 29, 0, "382987055@qq.com", "http://www.lgstatic.com/i/image2/M01/2F/09/CgoB5lzZKZOAZFlbAABCFbmSTGs258.jpg")
